      <div class="form-group">
        ...
        <div class="col-sm-3">
          <input class="form-control" id="com_staff_id" type="text" name="com_staff_id" onchange="getstaffinfo(this.value, 'v_upgradeCompletion')" wid="5" rid="5" value="<?php echo $staff_id; ?>">
        </div>
