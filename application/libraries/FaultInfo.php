...
class FaultInfo {
	  ...
	  $sql="select o.id, o.serial, o.staff_id, s.name, c.customer_id, c.customer_name, sf.createddate from orders o join customers c on o.customer_id = c.customer_id join devhktp.staff s on o.staff_id = s.staffid join square_fault sf on o.id = sf.orders_id where o.id=right(?,6) order by sf.createddate desc";
