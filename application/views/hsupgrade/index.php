    <!-- Page Content -->
       <!-- menu in header.php -->
		  ...
		  &nbsp;Upgrade/Addon Management &nbsp;&nbsp;&nbsp

      		  <button type="button" class="btn btn-info btn-lg glyphicon glyphicon-collapse-up" id="infotoggle" data-toggle="collapse" data-target="#upgradeinfo">&nbsp;Upgrade/Addon Detail</button></h3>&nbsp;&nbsp;&nbsp;
